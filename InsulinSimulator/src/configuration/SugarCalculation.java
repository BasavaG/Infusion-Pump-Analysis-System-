...
public class SugarCalculation {
	private static SugarCalculation BSLCalculation = null;
	...
	public SugarCalculation() {
	}

	public static synchronized SugarCalculation getInstance() {

		if (BSLCalculation == null) {
			BSLCalculation = new SugarCalculation();
		}
